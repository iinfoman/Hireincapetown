...
import { ListYourBusiness, HowVettingWorks, Report, Privacy } from './pages/Info.jsx';
...
export const PAGES = { Home, Results, Business, ListYourBusiness, HowVettingWorks, Report, Privacy };
